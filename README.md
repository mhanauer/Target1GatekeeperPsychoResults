...
Sec2 <- fa(r = datPrePost3monthSec2Base, nfactors = 3, n.iter = 100, fm = "gls", missing = TRUE, impute = "median", cor = "poly")
Sec2
fa.diagram(Sec2)

Sec3 <- fa(r = datPrePost3monthSec3Base, nfactors = 3, n.iter = 1000, fm = "gls", missing = TRUE, impute = "median", cor = "poly")
Sec3
fa.diagram(Sec3)

Sec4 <- fa(r = datPrePost3monthSec4Base, nfactors = 3, n.iter = 1000, fm = "gls", missing = TRUE, impute = "median", cor = "poly")
Sec4
fa.diagram(Sec4)
