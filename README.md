...
plot(vals[, "z"], 1 / sqrt(vals[, "test.info"]), type = "l", lwd = 2, xlab = "Ability", ylab = "Standard Error", main = "Standard Error of Measurement General Zero Suicide Attitudes")
...
plot(vals[, "z"], 1 / sqrt(vals[, "test.info"]), type = "l", lwd = 2, xlab = "Ability", ylab = "Standard Error", main = "Standard Error of Measurement Specific Zero Suicide Attitudes")

```
Get normative scales for each
```{r}
datM3F1 = datM3F1[c("Sec3Qa.x", "Sec3Qc.x", "Sec3Qd.x", "Sec3Qg.x")]
datM3F1_norm = na.omit(datM3F1)
datM3F2 = datM3F2[c("Sec3Qe.x", "Sec3Qf.x", "Sec3Qb.x")]
Sec2IRT
