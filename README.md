...
```
Descriptives
Should be 297 at each time point
```{r}
...
model4_f2_fA = 'F1 =~ Sec4QcA.x + Sec4QgA.x + Sec4QjA.x + Sec4QeA.x + Sec4QbB.x + Sec4QhB.x + Sec4QfB.x + Sec4QkA.x + Sec4QiB.x + Sec4QaB.x + Sec4QdB.x 
F2 =~ Sec4QdA.x + Sec4QeB.x + Sec4QgB.x + Sec4QaA.x + Sec4QlA.x  + Sec4QhA.x + Sec4QjB.x
'
```{r}
...
omegaSec4_F1 = datPrePost3monthSec4Psych[c("Sec4QcA.x", "Sec4QgA.x", "Sec4QjA.x", "Sec4QeA.x", "Sec4QbB.x", "Sec4QhB.x", "Sec4QfB.x", "Sec4QkA.x", "Sec4QiB.x", "Sec4QaB.x", "Sec4QdB.x")]
omegaSec4_F1 = omega(omegaSec4_F1)
summary(omegaSec4_F1)


omegaSec4_F2 =  omega(datPrePost3monthSec4Psych[c("Sec4QdA.x", "Sec4QeB.x", "Sec4QgB.x", "Sec4QaA.x", "Sec4QlA.x", "Sec4QhA.x", "Sec4QjB.x")])
summary(omegaSec4_F2)
```
...
vss(datPrePost3monthSec3F1Psych, n = 3)
vss(datPrePost3monthSec3F2Psych, n = 3)
...
Sec4F3 <- fa(r = Sec4PsychEFA[c(-1)], nfactors = 3, missing = TRUE, impute = "median")
Sec4F3
fa.diagram(Sec4F3)
...
#####################
Section 4 Work
Evidence of a two factor solution from paran and map test, but also getting hints of 4 as well
#####################
Sec4QcB.x
Sec4QiA.x
```{r}
model4_f2 = 'F1 =~ Sec4QcA.x + Sec4QgA.x + Sec4QjA.x + Sec4QeA.x + Sec4QbB.x + Sec4QhB.x + Sec4QfB.x + Sec4QkA.x + Sec4QiB.x + Sec4QaB.x + Sec4QdB.x 

F2 =~ Sec4QdA.x + Sec4QeB.x + Sec4QgB.x + Sec4QaA.x + Sec4QlA.x + Sec4QfA.x + Sec4QhA.x + Sec4QiA.x + Sec4QjB.x + Sec4QcB.x
'


fit4_f2 = cfa(model4_f2, estimator = "MLR",  missing = "ML", data = Sec4PsychCFA[c(-1)])
summary(fit4_f2, fit.measures = TRUE, standardized = TRUE)

model4_f2_no_CB = 'F1 =~ Sec4QcA.x + Sec4QgA.x + Sec4QjA.x + Sec4QeA.x + Sec4QbB.x + Sec4QhB.x + Sec4QfB.x + Sec4QkA.x + Sec4QiB.x + Sec4QaB.x + Sec4QdB.x 

F2 =~ Sec4QdA.x + Sec4QeB.x + Sec4QgB.x + Sec4QaA.x + Sec4QlA.x + Sec4QfA.x + Sec4QhA.x + Sec4QiA.x + Sec4QjB.x
'

fit4_f2_no_CB = cfa(model4_f2_no_CB, estimator = "MLR",  missing = "ML", data = Sec4PsychCFA[c(-1)])
summary(fit4_f2_no_CB, fit.measures = TRUE, standardized = TRUE)

model4_f2_no_CB_jA = 'F1 =~ Sec4QcA.x + Sec4QgA.x + Sec4QjA.x + Sec4QeA.x + Sec4QbB.x + Sec4QhB.x + Sec4QfB.x + Sec4QkA.x + Sec4QiB.x + Sec4QaB.x + Sec4QdB.x 

F2 =~ Sec4QdA.x + Sec4QeB.x + Sec4QgB.x + Sec4QaA.x + Sec4QlA.x + Sec4QfA.x + Sec4QhA.x + Sec4QjB.x
'

fit4_f2_no_CB_iA = cfa(model4_f2_no_CB_jA, estimator = "MLR",  missing = "ML", data = Sec4PsychCFA[c(-1)])
summary(fit4_f2_no_CB_iA, fit.measures = TRUE, standardized = TRUE)
...
fit4_f2_fA = cfa(model4_f2_fA, estimator = "MLR",  missing = "ML", data = Sec4PsychCFA[c(-1)])
summary(fit4_f2_fA, fit.measures = TRUE, standardized = TRUE)
...
dim(head(datPrePost3monthSec2Psych[c(-1)]))
head(datPrePost3monthSec2Psych)

Sec2IRT =  datPrePost3monthSec2Psych[c(-1)]
Sec2IRT$Sec2Qd.x = NULL
describe(Sec2IRT)
dim(datPrePost3monthSec2Psych)
dim(Sec2IRT)
...
summary(fitOrdGRM_Measure2_2PL)

information(fitOrdGRM_Measure2_2PL, c(-3, 1))

plot(fitOrdGRM_Measure2_2PL, category = 1, lwd = 2, cex = 1.2, legend = TRUE, cx = -4.5, cy = 0.85, xlab = "Latent Trait", cex.main = 1.5, cex.lab = 1.3, cex.axis = 1.1)

plot(fitOrdGRM_Measure2_2PL, category = 2, lwd = 2, cex = 1.2, legend = TRUE, cx = -4.5, cy = 0.85, xlab = "Latent Trait", cex.main = 1.5, cex.lab = 1.3, cex.axis = 1.1)

plot(fitOrdGRM_Measure2_2PL, category = 3, lwd = 2, cex = 1.2, legend = TRUE, cx = -4.5, cy = 0.85, xlab = "Latent Trait", cex.main = 1.5, cex.lab = 1.3, cex.axis = 1.1)

plot(fitOrdGRM_Measure2_2PL, category = 4, lwd = 2, cex = 1.2, legend = TRUE, cx = -4.5, cy = 0.85, xlab = "Latent Trait", cex.main = 1.5, cex.lab = 1.3, cex.axis = 1.1)


vals <- plot(fitOrdGRM_Measure2_2PL, type = "IIC", items = 0, plot = FALSE, zrange = c(-3,3)) 

plot(vals[, "z"], 1 / sqrt(vals[, "test.info"]), type = "l", lwd = 2, xlab = "Ability", ylab = "Standard Error", main = "Standard Error of Measurement Zero Suicide Clinical Skills")
...
plot(vals[, "z"], 1 / sqrt(vals[, "test.info"]), type = "l", lwd = 2, xlab = "Ability", ylab = "Standard Error", main = "Standard Error of Measurement General Suicide Attitudes")
...
plot(vals[, "z"], 1 / sqrt(vals[, "test.info"]), type = "l", lwd = 2, xlab = "Ability", ylab = "Standard Error", main = "Standard Error of Measurement Zero Suicide Attitudes")

```
Correlations between measures
```{r}
head(datM3F2)
m3_f2_mean = apply(datM3F2, 1, mean, na.rm  = TRUE)
m3_f1_mean =  apply(datM3F1, 1, mean, na.rm = TRUE)
m2_f1 = apply(Sec2IRT, 1, mean, na.rm = TRUE)
cor.test(m2_f1, m3_f1_mean)
cor.test(m2_f1, m3_f2_mean)
cor.test(m3_f1_mean, m3_f2_mean)
```
...
datPrePost3monthSec4Psych = read.csv("datPrePost3monthSec4Psych.csv", header = TRUE)
```
Descriptives for measures at baseline

F1 =~ Sec3Qa.x +  + Sec3Qc.x + Sec3Qd.x +Sec3Qg.x 
F2 =~  Sec3Qe.x + Sec3Qf.x + Sec3Qb.x

```{r}
dim(subset(datPrePost3monthSec2Psych, time == 0))

#Section two
datPrePost3monthSec2PsychBase = subset(datPrePost3monthSec2Psych, time == 0)
describe(datPrePost3monthSec2PsychBase)
apply(datPrePost3monthSec2PsychBase, 2, sd, na.rm = TRUE)

#Section three
datPrePost3monthSe3PsychBase = subset(datPrePost3monthSec3Psych, time == 0)
describe(datPrePost3monthSe3PsychBase)
...
timeM2_DIF = lordif(resp.data = datIRT_M2Items, group = datIRT_M2Descript$time, criterion = "Chisqr", alpha = .01, minCell = 5)
summary(timeM2_DIF)
plot(timeM2_DIF)
...
Get rid of NAs
Total score
Then get quartiles for time maybe even for gender and race 

```{r}
head(datIRT_M2)
dim(datIRT_M2)
dat_M2_complete = na.omit(datIRT_M2)
dat_M2_complete_items = dat_M2_complete[,6:20]
head(dat_M2_complete_items)

###Overall####
dat_M2_total_score =  apply(dat_M2_complete_items, 1, sum)
head(dat_M2_total_score)
quantile(dat_M2_total_score)


### Now breakdown by time
dat_M2_complete_items_time = dat_M2_complete[c(5:20)]
dat_M2_complete_items_base = subset(dat_M2_complete_items_time, time ==0)
dat_M2_complete_items_6month = subset(dat_M2_complete_items_time, time ==1)

dat_M2_complete_items_base$time = NULL
dat_M2_complete_items_6month$time = NULL


#### Total scores
dat_M2_total_score_base = apply(dat_M2_complete_items_base, 1, sum)
dat_M2_total_score_6month = apply(dat_M2_complete_items_6month, 1, sum)

#### Quatiles
quantile(dat_M2_total_score_base)
quantile(dat_M2_total_score_6month)
