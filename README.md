...
```
Now I we have the EFAs with up to four factors (a little easier to read).  The lambda's are the standardized factor loading
```{r}
Sec1 <- fa(r = datPrePost3monthSec1Base, nfactors = 4)
Sec1
fa.diagram(Sec1)

Sec2 <- fa(r = datPrePost3monthSec2Base, nfactors = 4)
Sec2
fa.diagram(Sec2)

Sec3 <- fa(r = datPrePost3monthSec3Base, nfactors = 4)
Sec3
fa.diagram(Sec3)

Sec4 <- fa(r = datPrePost3monthSec4Base, nfactors = 4)
Sec4
fa.diagram(Sec4)
