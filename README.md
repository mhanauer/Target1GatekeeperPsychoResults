...
Sec3 <- fa(r = Sec3PsychEFA[c(-1)], nfactors = 3, n.iter = 100, fm = "gls", missing = TRUE, impute = "median", cor = "poly")
Sec3
fa.diagram(Sec3)

# Responses are somewhat continious the defaults will work
Sec4 <- fa(r = Sec4PsychEFA[c(-1)], nfactors = 4, n.iter = 100, missing = TRUE, impute = "median")
Sec4
fa.diagram(Sec4)
```
...
fit3 = cfa(model3, estimator = "MLR",  missing = "fiml", std.lv = TRUE, data = Sec3PsychCFA[c(-1)])
